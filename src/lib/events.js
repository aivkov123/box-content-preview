...
export const LOAD_METRIC = {
    ...
    firstRenderTime: 'first_render_time', // Time from preview start to first visual content
    ...
    preloadContentLoadTimeDiff: 'preload_content_load_time_diff', // Difference between content load time and preload time.
};
...
export const FIRST_RENDER_METRIC = 'first_render_metric';
